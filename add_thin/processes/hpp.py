...
def generate_hpp(
    ...
    if intensity.dim() == 0:
        print('in dim 0 condition create a new full tensor.')
        intensity = torch.full(n_sequences, intensity.item)

    # Get number of samples
    # print(f'tma: {tmax.shape}, intensity: {intensity.shape}')
    ...
    # print(f'n_samples: {n_samples}, shape:  {n_samples.shape}, ')
    mask = (
